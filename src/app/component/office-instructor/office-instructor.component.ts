...
@Component({
  selector: 'app-office-instructor',
  templateUrl: './office-instructor.component.html',
  styleUrls: ['./office-instructor.component.css']
})
export class OfficeInstructorComponent implements OnInit {
